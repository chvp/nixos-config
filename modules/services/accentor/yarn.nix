{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "sass___sass_1.45.0.tgz";
      path = fetchurl {
        name = "sass___sass_1.45.0.tgz";
        url  = "https://registry.yarnpkg.com/sass/-/sass-1.45.0.tgz";
        sha1 = "192ede1908324bb293a3e403d1841dbcaafdd323";
      };
    }
    {
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha1 = "5dfae4d78c717c400530731f0b75c0350c3b6add";
      };
    }
    {
